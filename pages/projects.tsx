    ...
    <>
      <Container maxWidth="lg">
        ...
        <Typography mt={2} sx={{ textIndent: "2em", textAlign: "justify" }}>
          ...
          They explained how we could join the competition, so when I got home,
          I looked up the list of skills. That is when I noticed a new one:
          Industry 4.0. It was hosted at Technocampus in Mons, a place I had
          already been to multiple times and where I knew some of the trainers,
          including the organizer. I decided to sign up and went to the
        ...
        <Typography mt={2} sx={{ textIndent: "2em", textAlign: "justify" }}>
          ...
          Unfortunately, the competition was cancelled after three months
          because we did not have enough participants.
        </Typography>
        <Typography mt={2} sx={{ textIndent: "2em", textAlign: "justify" }}>
          In conclusion, I have learned a lot about TIA Portal and how things
          are done in Industry 4.0, like the software they used or the
          communication system. It has also made me realise that working with
          TIA is easier than working with Unity because the built-in help is
          well done.
        </Typography>
        <Typography
          gutterBottom
        ...
        <Typography mt={2} sx={{ textIndent: "2em", textAlign: "justify" }}>
          <Typography mt={2} sx={{ textIndent: "2em", textAlign: "justify" }}>
            ...
            using the appropriate TIA block, finding the best PID numbers by
            trial and error. I controlled the fans using Pulse Width Modulation
            (PWM) and worked on analogue values for Siemens PLCs..
          </Typography>
        </Typography>
        <Typography mt={2} sx={{ textIndent: "2em", textAlign: "justify" }}>
